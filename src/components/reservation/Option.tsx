...
export const Option: React.FC = () => {
    ...
    //     const res = await contract.getPingString()
    //     console.log(res)
    //     console.log(account)
    // }
    ...
    const handleGetStatus = async () => {
        ...
        //     purposeStartDate: startDate, // Assuming you have these values calculated elsewhere
        //     purposeEndDate: endDate,
        //     purposeNight: dayDifference
        // })
        console.log(res)
    }
